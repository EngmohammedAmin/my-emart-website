            ...
            <div class="row align-items-center">
                ...
                <div class="col-3 d-flex align-items-center m-none head-search">
                    <div class="dropdown ml-4">
                        <a class="text-dark dropdown-toggle d-flex align-items-center p-0" href="#"
                    ...
                    <div class="d-flex align-items-center justify-content-end pr-5">
                        ...
                        <div class="icon d-flex align-items-center text-dark takeaway-div">
                            <span class="takeaway-btn">
                                ...
                                <input type="checkbox" onclick="takeAwayOnOff(this)" <?php if(Session::get('takeawayOption') == "true"){ ?> checked
                                    <?php } ?>> <span class="slider round"></span>
                            </span>
                        </div>
                        <?php    }else {?>
