    ...
    <div class="container">
        ...
        <div class="transactions-banner p-4 rounded">
            <div class="row align-items-center text-center">
                <div class="col-md-6">
                    <h3 class="font-weight-bold h4 text-light">{{ trans('lang.total') }} {{ trans('lang.payment') }} :
                    </h3>
                            ...
                            <ul class="pagination justify-content-center">
                                <li class="page-item ">
                                    <a class="page-link" href="javascript:void(0);" id="users_table_previous_btn"
                                        onclick="prev()" data-dt-idx="0" tabindex="0">{{ trans('lang.previous') }}
                                    </a>
                                </li>
                                <li class="page-item">
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            html = html +
                ...
                date + ' ' + time + '</h6><p class="mb-0 badge badge-success text-light">' + val
                .payment_status + '</p><p class="text-muted mb-0">' + val.payment_method + '</p></div></div>';

            html = html + '<div class="float-right ml-auto"><span class="price font-weight-bold h4">' +
                price_val + '</span>';
            ...
            if (val.order_id != '') {
                ...
                html = html + '<span class="go-arror text-dark btn-block text-right mt-2"><a href="' +
                    view_details + '"><i class="fa fa-angle-right"></i></a></span>';
            }
