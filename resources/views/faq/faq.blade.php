...
<!-- Mirrored from askbootstrap.com/preview/swiggiweb/faq.html by HTTrack Website Copier/3.x [XR&CO2014], Tue, 04 Jan 2022 10:58:46 GMT -->
...
<body class="fixed-bottom-bar">
                    ...
                    <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
                        <a href="profile.html" class="">
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="right">
                                    <h6 class="mb-1 font-weight-bold">{{ trans('lang.afghanistan') }}Gurdeep Singh <i
                        ...
                        <div class="bg-white profile-details">
                            ...
                            <a data-toggle="modal" data-target="#exampleModal"
                                ...
                                <div class="left mr-3">
                                    ...
                                    <p class="small text-muted m-0">{{ trans('lang.add_remove_delivery_address') }}
                                    </p>
                                </div>
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                    ...
                    <div class="osahan-cart-item-profile">
                        <div class="box bg-white mb-3 shadow-sm rounded">
                            ...
                            <div class="overflow-hidden border-top d-flex align-items-center p-3">
                                <a class="font-weight-bold d-block" href="#"> {{ tans('lang.help_forum') }}
                                </a>
                        ...
                        <div class="box bg-white mb-3 shadow-sm rounded">
                            ...
                            <div class="overflow-hidden border-top d-flex align-items-center p-3">
                                <a class="font-weight-bold d-block" href="#">
                                    {{ trans('lang.swiggiweb_safety_center') }} </a>
                                <i class="feather-arrow-right-circle ml-auto text-primary"></i>
                            </div>
                        </div>
                        <div id="basics">
                            ...
                            <div id="accountAccordion">
                                ...
                                <div class="box border-bottom bg-white mb-2 rounded shadow-sm overflow-hidden">
                                    ...
                                    <div id="accountCollapseFour" class="collapse"
                                        aria-labelledby="accountHeadingFour" data-parent="#accountAccordion">
                                        <div class="card-body border-top p-3 text-muted">
                                            {{ trans('lang.anim_pariatur_message') }}
                                        </div>
                                    </div>
                ...
                <div class="row pt-3">
                    ...
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="coming-soon.html" class="text-muted">{{ trans('lang.coming_soon') }}</a>
                            </li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="{{ route('faq') }}"
                                    class="text-muted">{{ trans('lang.delivery_support') }} </a></li>
                            <li> <a href="{{ url('contact_us') }}"
                                    class="text-muted">{{ trans('lang.contact_us') }}</a></li>
                            <li> <a href="{{ route('terms') }}" class="text-muted">{{ trans('lang.terms_use') }}
                                </a></li>
                    ...
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="signup.html" class="text-muted"> User {{ trans('lang.register') }} </a>
                            </li>
                            <li> <a href="forgot_password.html" class="text-muted">
                                    {{ trans('lang.forgot_password') }} </a></li>
                            <li> <a href="profile.html" class="text-muted"> {{ trans('lang.account_setting') }} </a>
                            </li>
                        </ul>
                    </aside>
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="vendor.html" class="text-muted"> {{ trans('lang.store_details') }} </a>
                            </li>
            ...
            <section class="footer-center border-top padding-y py-5">
                ...
                <div class="row">
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}India</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Indonesia</a>
                            </li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Ireland</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Italy</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Lebanon</a>
                            </li>
                        </ul>
                    </aside>
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Malaysia</a>
                            </li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}New Zealand</a>
                            </li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Philippines</a>
                            </li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Poland</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}Portugal</a>
                            </li>
                        </ul>
                    </aside>
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.afghanistan') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Brasil') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Canada') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Chile') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Czech Republic') }}</a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.Turkey') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.UAE') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.United Kingdom') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.United States') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Sri Lanka') }}</a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.Qatar') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Singapore') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Slovakia') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.South Africa') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Green Land') }}</a></li>
                        </ul>
                    </aside>
                    <aside class="col-sm-2 col-md-2 text-white">
                        <ul class="list-unstyled hov_footer">
                            <li> <a href="#" class="text-muted">{{ trans('lang.Pakistan') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Bangladesh') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Bhutaan') }}</a></li>
                            <li> <a href="#" class="text-muted">{{ trans('lang.Nepal') }}</a></li>
                        </ul>
                    </aside>
                </div>
        ...
        <section class="footer-copyright border-top py-3 bg-light">
            <div class="container d-flex align-items-center">
                ...
                <p class="text-muted mb-0 ml-auto d-flex align-items-center">
                    <a href="#" class="d-block"><img alt="#" src="img/appstore.png"
                            height="40"></a>
                    <a href="#" class="d-block ml-3"><img alt="#" src="img/playmarket.png"
                            height="40"></a>
                </p>
            </div>
        </section>
    ...
    <nav id="main-nav">
        <ul class="second-nav">
            ...
            <li><a href="trending.html"><i class="feather-trending-up mr-2"></i> {{ trans('lang.trending') }} </a>
            </li>
            <li><a href="most_popular.html"><i class="feather-award mr-2"></i> {{ trans('lang.most_popular') }} </a>
            </li>
            <li><a href="vendor.html"><i class="feather-paperclip mr-2"></i> {{ trans('lang.store_detail') }}</a>
            </li>
            <li><a href="checkout.html"><i class="feather-list mr-2"></i> {{ trans('lang.checkout') }} </a></li>
            <li><a href="successful.html"><i class="feather-check-circle mr-2"></i>
                    {{ trans('lang.successful') }}</a></li>
            ...
            <li>
                <a href="#"><i class="feather-link mr-2"></i> Navigation  Example</a>
                <ul>
                    <li>
                        <a href="#"> Example1</a>
                        <ul>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="small">{{ trans('lang.we_accept') }}<span
                            class="osahan-card ml-2 font-weight-bold">{{ trans('lang.master_visa_rupay_card') }}</span>
                    </p>
                    <form>
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <label
                                    class="form-label font-weight-bold small">{{ trans('lang.card_number') }}</label>
                            ...
                            <div class="col-md-8 form-group"><label
                                    ...
                                    placeholder="Enter Valid through(MM/YY)" type="number" class="form-control">
                            </div>
                            ...
                            <div class="col-md-12 form-group mb-0">
                                <div class="custom-control custom-checkbox"><input type="checkbox"
                                        id="custom-checkbox1" class="custom-control-input"><label title=""
                                        type="checkbox" for="custom-checkbox1"
                                        class="custom-control-label small pt-1">
                                        {{ trans('lang.save_this_card') }}
            ...
            <div class="modal-content">
                ...
                <div class="modal-body py-0">
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="mr-3"><img alt="#" src="img/user1.jpg"
                    ...
                    <div class="d-flex align-items-center mb-3">
                        <div class="mr-3"><img alt="#" src="img/user2.png"
                                class="img-fluid rounded-circle"></div>
                        <div>
