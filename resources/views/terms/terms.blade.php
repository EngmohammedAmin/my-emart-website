...
<body class="fixed-bottom-bar">
                    ...
                    <div class="col-8">
                        <div class="d-flex align-items-center justify-content-end pr-5">
                            ...
                            <a href="login.html" class="widget-header mr-4 text-dark m-none">
                                <div class="icon d-flex align-items-center">
                                    <i class="feather-user h6 mr-2 mb-0"></i> <span>{{ trans('lang.sign_in') }}
                                    </span>
                                </div>
                            </a>
                            ...
                            <a href="{{ route('faq') }}"
                                ...
                                <div class="left mr-3">
                                    <h6 class="font-weight-bold m-0 text-dark"><i
                                            class="feather-truck bg-danger text-white p-2 rounded-circle mr-2"></i>{{ trans('lang.delivery_support') }}
                                    </h6>
                                </div>
                                <div class="right ml-auto">
                                    <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
                    ...
                    <div class="osahan-cart-item-profile">
                        <div class="box bg-white mb-3 shadow-sm rounded">
                            ...
                            <div class="overflow-hidden border-top d-flex align-items-center p-3">
                                <a class="font-weight-bold d-block" href="#">{{ trans('lang.help_forum') }}
                                </a>
                ...
                <div class="row pt-3">
                    ...
                    <aside class="col-sm-3 col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="{{ url('contact_us') }}" class="text-muted">{{ trans('lang.contact_us') }}
                                </a></li>
                    ...
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="forgot_password.html"
                                    class="text-muted">{{ trans('lang.forgot_password') }} </a></li>
                    ...
                    <aside class="col-sm-3  col-md-2 text-white">
                        ...
                        <ul class="list-unstyled hov_footer">
                            ...
                            <li> <a href="most_popular.html" class="text-muted"> {{ trans('lang.most_popular') }}
                                </a></li>
    ...
    <nav id="main-nav">
        <ul class="second-nav">
            ...
            <li><a href="successful.html"><i class="feather-check-circle mr-2"></i> {{ trans('lang.successful') }}
                </a></li>
                    ...
                    <form>
                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <label class="form-label font-weight-bold small">{{ trans('lang.card_number') }}
                                </label>
                            ...
                            <div class="col-md-8 form-group"><label
                                    class="form-label font-weight-bold small">{{ trans('lang.valid_through_mm_yy') }}
                                </label><input placeholder="Enter Valid through(MM/YY)" type="number"
                            ...
                            <div class="col-md-12 form-group"><label
                                    class="form-label font-weight-bold small">{{ trans('lang.name_on_card') }}
                                </label><input placeholder="Enter Card number" type="text" class="form-control">
                            </div>
