                        ...
                        <div>
                            ...
                            <div class="form-group">
                                <h6>{{ trans('lang.know_your_cordinates') }} <a target="_blank"
                                        ...
                                        {{ trans('lang.latitude_and_longitude_finder') }} </a>
                                </h6>
                            </div>
                            <div class="form-group">
    ...
    $(document).ready(function() {
        ...
        ref.get().then(async function(snapshots) {
            ...
            if (snapshots.data()) {
                ...
                if (user.hasOwnProperty('wallet_amount') && user.wallet_amount != '' && user
                    .wallet_amount != '0') {
                ...
                if (photo != '') {
                    ...
                    $(".user_image").append('<img class="rounded" style="width:50px" src="' +
                        photo + '" alt="image">');
                } else {
