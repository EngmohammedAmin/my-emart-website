...
<nav id="main-nav" style="text-align-last: right;">

    <ul class="second-nav">

        <li style=""><a href="{{ url('/') }}"><i class="feather-home mr-2"></i>
                {{ trans('lang.home_page') }}</a></li>
        @auth
            ...
            <li><a href="{{ url('my_order') }}" style="display:none"><i class="feather-list mr-2" style="display:none"></i>
                    {{ trans('lang.my_orders') }}</a>
            </li>
            <?php }else{ ?>
            <li><a href="{{ url('my_order') }}"><i class="feather-list mr-2"></i> {{ trans('lang.my_orders') }}</a></li>
            <?php } ?>
            @if (@$_COOKIE['service_type'] == 'Cab Service')
                <li><a href="{{ url('transactions') }}" style="display:none"><i class="feather-list mr-2"
                            style="display:none"></i> {{ trans('lang.my_transactions') }}
                    </a></li>
            @else
                <li><a href="{{ url('transactions') }}"><i class="feather-list mr-2"></i>
            ...
            <li><a href="{{ url('favorite-stores') }}"><i class="feather-heart mr-2"></i>
                    {{ trans('lang.favorite_stores') }}</a></li>
            ...
            <li style="display:none;" class="dine_in_menu dineinrestaurant_tab hide_tab"><a
                    href="{{ url('my_dinein') }}"><i
                ...
                <div class="siddhi-filter">
                    <div class="filter">
                        ...
                        <div class="custom-control border-bottom px-0  custom-radio">
                            ...
                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio3f">
                                {{ trans('lang.cost_high_to_low') }} </label>
                        </div>
                        <div class="custom-control border-bottom px-0  custom-radio">
                        ...
                        <div class="custom-control border-bottom px-0  custom-radio">
                            ...
                            <label class="custom-control-label py-3 w-100 px-3" for="customRadio5f">
                                {{ trans('lang.most_popular') }} </label>
                        </div>
                        <div class="p-3 bg-light border-bottom">
