            ...
            <div class="row">
                ...
                <div class="col-md-4 parcel_payment_right">
                    <div class="card">
                        ...
                        <input type="hidden" id="receiverAddress" value="<?php echo $parcel_cart['receiverAddress']; ?>">
                        <input type="hidden" id="parcelDeliveryKM" value="<?php echo round($parcel_cart['parcelDeliveryKM'], 2); ?>">
                        <input type="hidden" id="senderParcelWeight" value="<?php echo $parcel_cart['senderParcelWeight']; ?>">
                        <input type="hidden" id="senderParcelWeightName" value="<?php echo $parcel_cart['senderParcelWeightName']; ?>">

                        <input type="hidden" id="parcelDeliveryCharge" value="<?php echo round($parcel_cart['parcelDeliveryCharge'], 2); ?>">

                        <input type="hidden" id="parcelCategoryId" value="<?php echo $parcel_cart['parcelCategoryId']; ?>">
                        <input type="hidden" id="senderNote" value="<?php echo $parcel_cart['senderNote']; ?>">

                        <input type="hidden" id="sender_address_lat" value="<?php echo $parcel_cart['sender_address_lat']; ?>">
                        <input type="hidden" id="sender_address_lng" value="<?php echo $parcel_cart['sender_address_lng']; ?>">
                        <input type="hidden" id="receiver_address_lng" value="<?php echo $parcel_cart['receiver_address_lng']; ?>">
                        <input type="hidden" id="receiver_address_lat" value="<?php echo $parcel_cart['receiver_address_lat']; ?>">
                        <input type="hidden" id="deliveryCharge" value="<?php echo round($parcel_cart['deliveryCharge'], 2); ?>">


                        <input type="hidden" id="isSchedule" value="<?php echo $parcel_cart['isSchedule']; ?>">
                        <input type="hidden" id="senderPickupDateTime" value="<?php echo $parcel_cart['senderPickupDateTime']; ?>">
                        <input type="hidden" id="receiverPickupDateTime" value="<?php echo $parcel_cart['receiverPickupDateTime']; ?>">
                        ...
                        <div class="parcel_payment-way">
                            ...
                            <div class="payment_by">
                                ...
                                <div class="payment_by_option">
                                    <ul>
                                        ...
                                        <li>
                                            <input type="radio" id="payment_by" name="payment_by"
                                                value="receiver">
                            ...
                            <input type="hidden" id="discount" value="<?php echo number_format($discount, $decimal_degits); ?>">
                        ...
                        <input type="hidden" id="total_pay" value="<?php echo number_format($total, $decimal_degits); ?>">
                        ...
                        <div class="pay-btn">
                            <a href="Javascript:void(0)" id="pay_parcel"
                                onclick="payCheckoutParcel()">{{ trans('lang.pay') }} <span
                                    ...
                                    ?> <span
                                        class="currency-symbol-right"></span></span></a>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    async function getCouponDetails() {
        ...
        let menuHtmlx = couponRef.get().then(async function(couponRefSnapshots) {
            couponHtml +=
                '<div class="coupon-code"><label>{{ trans('lang.Available_Coupons') }}</label><span></span></div>';
            ...
            couponRefSnapshots.docs.forEach((doc) => {
                ...
                if (coupon.isEnabled == true) {
                    couponHtml += '<li value="' + coupon.code + '"><a href="#">' + coupon.code +
                        '</a></li>';
    ...
    $(document).on("click", '#apply-coupon-code', function(event) {
        ...
        var couponCodeRef = database.collection('parcel_coupons').where('code', "==", coupon_code).where(
    ...
    function payCheckoutParcel() {
        ...
        userDetailsRef.get().then(async function(userSnapshots) {
            ...
            if ((senderPickupDateTime == null || senderPickupDateTime == "") && (receiverPickupDateTime ==
                    null || receiverPickupDateTime == "")) {
            ...
            senderPickupDateTime = firebase.firestore.Timestamp.fromDate(new Date(senderPickupDateTime))
                .toDate();
            receiverPickupDateTime = firebase.firestore.Timestamp.fromDate(new Date(receiverPickupDateTime))
                .toDate();
                    ...
                    $.ajax({
                        ...
                        success: async function(data) {
                            ...
                            if (payment_method == "wallet") {
                                ...
                                database.collection('users').doc(authorID).update({
                                    'wallet_amount': wallet_amount
                                }).then(function(result) {
                                    window.location.href =
                                        "<?php echo url('parcel_success'); ?>";
