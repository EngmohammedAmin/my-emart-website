                                    ...
                                    <div class="py-5 linus-coming-soon d-flex justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="text-center pb-3">
                                                ...
                                                <p>{{ trans('lang.check_order') }} <a href="{{ route('my_order') }}"
        ...
        function finalCheckout() {
            ...
            userDetailsRef.get().then(async function(userSnapshots) {
                ...
                if (order_json.senderPickupDateTime != null && order_json.receiverPickupDateTime != null) {
                    ...
                    senderPickupDateTime = firebase.firestore.Timestamp.fromDate(new Date(order_json
                        .senderPickupDateTime)).toDate();
                    receiverPickupDateTime = firebase.firestore.Timestamp.fromDate(new Date(order_json
                        .receiverPickupDateTime)).toDate();
                }
                ...
                if (order_json.discount != null && order_json.coupon_id != null && order_json.discountType !=
                    null && order_json.discountLabel != null) {
                ...
                if (order_json.taxSetting && order_json.taxSetting != null && order_json.taxSetting != "null" &&
                    order_json.taxSetting != undefined) {
